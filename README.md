...
| :--- | :--- |
| **[🛡️ Stormshield CSNA (Training)](https://github.com/gerarddiaz01//Stormshield-Network-Security-Labs)**<br>*(Préparation à la certification Certified Stormshield Network Administrator)* | • **Déploiement Initial :** Initialisation d'appliances SNS, segmentation réseau.<br>• **Filtrage & NAT :** Création de politiques de sécurité et translation d'adresses.<br>• **Hardening :** Sécurisation du plan d'administration (SSH, WebUI).<br>• **Supervision :** Gestion des traces et optimisation des logs pour le SOC. |
